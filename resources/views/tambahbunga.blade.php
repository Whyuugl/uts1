            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4 mt-4">
                        <h1 class="mt-4">Tambah Bunga</h1>
                        <form action="/insertbunga" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Foto Bunga</label>
